...
string Trader_IO::readDateOfbirth()
{
    ...
    while (!isValidDateFormat(dateStr) || !isOver18YearsOld(dateStr)) {
...
bool Trader_IO::isValidEmailFormat(const string& email) 
{
...
string Trader_IO::readSignlePassword(const string& prompt)
{
    string password;
    cout << prompt << endl;
...
string Trader_IO::readPasswords()
{
    ...
    do {
        password1 = readSignlePassword("Enter your Password: ");
    ...
    do {
        password2 = readSignlePassword("Confirm your Password: ");
...
string Trader_IO::removeRedundantSpaces(const string& str) 
{
    string result;
...
bool Trader_IO::isValidPhoneNumber(const string& phoneNumber) {
...
bool Trader_IO::isValidDateFormat(const string& dateStr) 
{
...
bool Trader_IO::isOver18YearsOld(const string& dateStr)
{
